...
category: "other"
tags: ["agent sdk development plugin", "overview", "features", "→ installs latest sdk version", "workflow example", "set your api key", "run your agent", "installation", "best practices", "resources"]
triggers: []
dependencies: []
source: "E:/Bobo's Coding cache/.claude/skills/agent-sdk-dev"
---
