---
id: "agent-tools"
title: "inference.sh(https://inference.sh)"
category: "other"
tags: ["install cli", "quick examples", "generate an image", "generate a video", "call claude", "web search", "post to twitter", "generate 3d model", "commands", "what's available"]
triggers: []
dependencies: []
source: "E:/Bobo's Coding cache/.claude/skills/agent-tools"
---
