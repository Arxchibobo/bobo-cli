...
category: "knowledge"
tags: ["meeting insights analyzer", "when to use this skill", "what this skill does", "how to use", "instructions", "examples", "conflict avoidance patterns", "recommendations", "setup tips", "common analysis requests"]
triggers: []
dependencies: []
source: "E:/Bobo's Coding cache/.claude/skills/meeting-insights-analyzer"
---
