...
category: "research"
tags: ["research executor", "role", "core responsibilities", "tool usage guidelines", "success metrics", "examples", "remember"]
triggers: []
dependencies: []
source: "E:/Bobo's Coding cache/.claude/skills/research-executor"
---
...
### WebFetch / mcp**web_reader**webReader

- Use for extracting content from specific URLs
- Prefer mcp**web_reader**webReader for better extraction
